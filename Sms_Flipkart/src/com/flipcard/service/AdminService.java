...
public class AdminService implements AdminServiceInterface {
	...
	// Create the catalog of course catalog class that interact with catalog tables
	...
	@Override
	/*
	 * Create professor and specify the date, time and day when student is created 
	 */
	...
	@Override
	/*
	 * Create administrator and specify the date, time and day when student is created
	 */
	...
	public void deleteUser(String username, String role) throws UserNotExistForRole {
			...
			// if deleted successfully the give message with date time and day else throw user not exist exception
			if(deleted) {
