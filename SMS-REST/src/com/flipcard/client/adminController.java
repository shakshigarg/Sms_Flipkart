...
public class adminController {	
	...
	/*
	 * the method is used to get student details
	 * It is using the @get annotation
	 */	
	@GET
	@Path("/studentDetails")
	...
	/*
	 * the method is used to get course details
	 * It is using the @get annotation
	 */	
	...
	/*
	 * the method is used to get professor details
	 * It is using the @get annotation
	 */		
	@GET
	...
	/*
	 * the method is used by authenticated administrator to delete student or professor
	 * It is using the @delete annotation
	 */	
	...
	/*
	 * the method is used by authenticated admin to update a course
	 * It is using the @put annotation
	 */	
